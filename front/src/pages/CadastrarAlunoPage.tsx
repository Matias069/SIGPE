...
export default function CadastrarAlunoPage() {
      ...
      const timer = setTimeout(() => {
         apiClient
            ...
            .catch((error) => {
               ...
               setErro(
                  handleApiError(error, "Não foi possível carregar as turmas.")
               );
            })
   ...
   const handleSubmit = async (event: React.FormEvent) => {
      ...
      try {
         ...
         setErro(
            handleApiError(error, "Ocorreu um erro ao cadastrar o aluno.")
         );
      }
   };
               ...
               <div>
                  ...
                  <div className="relative">
                     <input
                        ...
                        value={
                           selectedTurma
                              ? `${selectedTurma.curso} - ${selectedTurma.numeroTurma}`
                              : turmaSearch
                        }
                        onChange={(e) => {
