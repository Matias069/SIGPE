  ...
  return (
    <div className="page">
      ...
      <div className="image-container">
        <img src={expocanp} alt="Foto da Expocanp" className="expocanp-image" />
      </div>
      <h3 className="text-center">REGRAS DE PARTICIPAÇÃO</h3>
      <p className="text-center">A participação na EXPOCANP/SEMATEC é obrigatória, correspondendo às atividades letivas dos cursos.</p>
